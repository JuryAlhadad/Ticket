...
<html lang="en">
   ...
   <div class="mb-3">
      ...
      <input type="text" id="Career_Number" value="No connection at the Main branch4011" class="form-control mb-2" readonly>
          ...
          <div class="col-md-6">
          <div class="mb-3">
      <label for="Inline"><strong>Inline Phone:</strong></label>
      <input type="text" id="Inline" value="No connection at the Main branch4011" class="form-control mb-2" readonly>
            </div>
            </div>
            </div>
