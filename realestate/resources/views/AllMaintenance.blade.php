                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>61</td>
                                             <td>61</td> 
                                            <td class="actions">
                                            <button class="edit-btn" onclick="window.location.href='{{url('/viewMaint') }}'">View</button>    
                                            <button class="edit-btn" onclick="window.location.href='{{url('/Assign') }}'">Assign</button></td>
                                        </tr>
                                    </tbody>
                                </table>
