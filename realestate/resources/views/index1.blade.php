...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       ...
       <img src="{{asset('img/bank.png')}}" class="logo" alt="logo">  
        ...
        <tr>
            <td>{{ $ticket->id }}</td>
            <td>{{ $ticket->employee->first_name ?? 'Unknown' }} {{ $ticket->employee->last_name ?? '' }}</td>
            <td>{{ $ticket->title }}</td>
            <td>{{ $ticket->status ?? 'Pending' }}</td>
            <td>{{ $ticket->assigned_to ?? 'Not assigned' }}</td>
            <td class="actions">
               <button class="edit-btn" onclick="window.location.href='{{ url('/TicketView/' . $ticket->id) }}'">View</button>
